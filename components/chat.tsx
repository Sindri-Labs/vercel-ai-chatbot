...
export function Chat({
  ...
  const {
    ...
    experimental_prepareRequestBody: (body: { messages: Array<UIMessage> }) => {
      ...
      // Transform UIMessage to match API schema
      const message = {
        id: lastMessage.id,
        createdAt: (lastMessage.createdAt || new Date()).toISOString(),
        role: lastMessage.role,
        content: getTextContent(),
        parts: lastMessage.parts || [{ type: 'text' as const, text: getTextContent() }],
